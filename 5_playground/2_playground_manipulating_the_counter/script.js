...
// or we can use an arrow function to create event listeners
// incrementBtn.addEventListener('click', () => {
//   console.log("Whatever the hell you like...")
// })
  ...
  const em = document.createElement("em")   // create an em tag
...
function decrementCounter() {
  // to remove elements from the li tag
